...
import { ArrowRight, Cpu, Zap, Github, Linkedin, Instagram, Youtube, Mail, GitCommit, CheckCircle, Terminal, Wifi, Activity, Settings, PenTool, Box, Layers } from 'lucide-react';
